...
export class RequestMentorshipRejectAsMentorTest extends BaseRestTest {
    ...
    public RejectMentorshipRequestAndValidateStatus(): void {
        ...
        __page2 = __page2.clickAcceptRejectButton(String.valueOf(this.user.name), "Reject");
        __page2 = __page2.clickYesRejectButton();
        __page2 = __page2.selectAFilterOption("mentor-options-REJECTED");
        expect(__page2.mentorApplicationStatusText(String.valueOf(this.user.name), "Rejected")).toBeVisible({ timeout: 30000 });
