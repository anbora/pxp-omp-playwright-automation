...
export class CreateJobVacanciesTest_SkillLevel extends BaseRestTest {
    ...
    public initialize(): void {
      ...
      this.jobModel = this.getObjectFromJson("fixtures/job/PublicOpportunityWithDeclaredLinkedRoleDto.json", JobModel);
        ...
        this.createJob(this.guineaPigStylist, this.jobModel);
        this.jobModel.setId(this.jobId2);
        this.createJob(this.miceStylist, this.jobModel);
        this.jobModel.setId(this.jobId3);
        this.createJob(this.marmotStylist, this.jobModel);
        ...
        this.createJob(this.chipmunkStylist, this.jobModel);
      ...
      this.jobModel2 = this.getObjectFromJson("fixtures/job/PublicOpportunityDto.json", JobModel);
        ...
        this.createJob(this.headOfDevelopmentInLumesse, this.jobModel2);

        this.jobModel2.setLevel("MID_SENIOR");
        this.jobModel2.setJobDescriptions(jobDescriptionList);
        this.jobModel2.setId(this.jobId6);
        this.createJob(this.devOpsAzureSolutionArchitect, this.jobModel2);
        ...
        this.createJob(this.devSecOpsLead, this.jobModel2);
      ...
      this.jobModel3 = this.getObjectFromJson("fixtures/job/PublicOpportunityWithDeclaredLinkedRoleDto.json", JobModel);
        ...
        this.createJob(this.insectBeautician, this.jobModel3);
        this.jobModel3.setId(this.jobId9);
        this.createJob(this.paranormalTourGuide, this.jobModel3);
        this.jobModel3.setId(this.jobId10);
        this.createJob(this.bikeFisher, this.jobModel3);
        this.jobModel3.setId(this.jobId11);
        this.createJob(this.homeworkSolver, this.jobModel3);
        this.jobModel3.setId(this.jobId12);
        this.createJob(this.catWhisperer, this.jobModel3);
        this.jobModel3.setId(this.jobId13);
        this.createJob(this.bedHeater, this.jobModel3);
        this.jobModel3.setId(this.jobId14);
        this.createJob(this.elephantStylist, this.jobModel3);
        this.jobModel3.setId(this.jobId15);
        this.createJob(this.fishCounter, this.jobModel3);
        this.jobModel3.setId(this.jobId16);
        this.createJob(this.golfBallSeeker, this.jobModel3);
        this.jobModel3.setId(this.jobId17);
        this.createJob(this.snakeMilker, this.jobModel3);
        this.jobModel3.setId(this.jobId18);
        this.createJob(this.roadMime, this.jobModel3);
        this.jobModel3.setId(this.jobId19);
        this.createJob(this.mermaid, this.jobModel3);
        this.jobModel3.setId(this.jobId20);
        this.createJob(this.babysitterForChildActors, this.jobModel3);
        this.jobModel3.setId(this.jobId21);
        this.createJob(this.dogFoodTester, this.jobModel3);
        this.jobModel3.setId(this.jobId22);
        this.createJob(this.fluffCollector, this.jobModel3);
        this.jobModel3.setId(this.jobId23);
        this.createJob(this.passengerStuffer, this.jobModel3);
      ...
      this.jobModel4 = this.getObjectFromJson("fixtures/job/PublicOpportunityDto.json", JobModel);
        ...
        this.createJob(this.jobWithPostingDateInThePast, this.jobModel4);

        this.jobModel4.setStartDateTime("2022-01-01T00:00:00.00Z");
        this.jobModel4.setId(this.jobId25);
        this.createJob(this.strikerFootballPlayer, this.jobModel4);
    }
    ...
    public shouldWaitForJobsToAppearAndAddSkill(): void {
        this.getOmpLoginPage()
                ...
                .removeAllIntermediateSkills()
                .addIntermediateSkill(this.sudoku)
                .addIntermediateSkill(this.cardGames)
                .clickSaveButton()
                .clickBackButton()
