...
export class VerifyBrowseBySubjectTest_SBX extends BaseTest {
  ...
  __page1 = __page1.logintoSBX("CSUSERTWO", "welcome");
  ...
  __page2 = __page2.logintoSBX("CSUSERTWO", "welcome");
  ...
  __page3 = __page3.logintoSBX("CSUSERTWO", "welcome");
  ...
  __page4 = __page4.logintoSBX("CSUSERTWO", "welcome");
  ...
  __page5 = __page5.logintoSBX("CSUSERTWO", "welcome");
  ...
  __page6 = __page6.logintoSBX("CSUSERTWO", "welcome");
  ...
  __page7 = __page7.logintoSBX("CSUSERTWO", "welcome");
  ...
  __page8 = __page8.logintoSBX("CSUSERTWO", "welcome");
