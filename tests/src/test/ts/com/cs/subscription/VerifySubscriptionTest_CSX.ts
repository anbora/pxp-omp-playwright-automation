	 ...
	 public verifyNewBadge(): void {
	  ...
	  public verifyNewFiltersCornerstoneCurated(): void {
		...
		public verifyStickyHeadersExploreSubscription(): void {
			...
			this.getCsLoginPage(this.getConfig().getThinkContentURL())
			.loginToThinkContent(this.getPlayFiveUser().email, this.getPlayFiveUser().password)
			.navigateToPageByPath(this.EXPLORESUBSCRIPTIONPATH, SubscriptionPage)
			.waitForCard(SubscriptionPage)
		...
		public verifyGlobalSearchCountCP(): void {
			...
			.navigateToPageByPath(this.EXPLORESUBSCRIPTIONPATH, SubscriptionPage)
			.clickContentPartnersTab()
			.searchContentPartners(this.CONTENTPARTNER_TO_SEARCH_BOOKBOON)
			.clickContentPartnersCard(this.CONTENTPARTNER_TO_SEARCH_BOOKBOON)
			.getCourseCount(this.resultcount)
			.getPageClass(BrowseBySubjectPage)
			.fillGlobalSearchBoxWithOutQuote(this.CONTENTPARTNER_TO_SEARCH_BOOKBOON)
			.clickSearch()
			.waitForCard()
			.waitForCard(SubscriptionPage)
			.check(SubscriptionAssertions)
			.assertThatButtonWithOptionVisible(this.resultcount.getValue())
			.endAssertion();
		}
		...
		public verifyGlobalSearchCountSubscription(): void {
			...
			.getCourseCount(this.resultcount)
			.getPageClass(BrowseBySubjectPage)
			.fillGlobalSearchBoxWithOutQuote(this.SUBSCRIPTION_TO_SEARCH)
			.clickSearch()
			.waitForCard()
			.waitForCard(SubscriptionPage)
			.check(SubscriptionAssertions)
