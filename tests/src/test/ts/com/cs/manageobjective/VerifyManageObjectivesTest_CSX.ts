...
export class VerifyManageObjectivesTest_CSX extends BaseTest{
    ...
    __page1 = __page1.loginToThinkContent(this.getPlayFourUser().email, this.getPlayOneUser().password);
    ...
    __page2 = __page2.loginToThinkContent(this.getPlayFourUser().email, this.getPlayOneUser().password);
    ...
    __page3 = __page3.loginToThinkContent(this.getPlayFourUser().email, this.getPlayOneUser().password);
    ...
    __page4 = __page4.loginToThinkContent(this.getPlayFourUser().email, this.getPlayOneUser().password);
    ...
    __page5 = __page5.loginToThinkContent(this.getPlayFourUser().email, this.getPlayOneUser().password);
	...
	public verifyObjectiveCreationGlobalIcon(): void {
		  ...
		  this.getCsLoginPage(this.getConfig().getThinkContentURL())
	      	.loginToThinkContent(this.getPlayFourUser().email, this.getPlayOneUser().password)
	...
	public verifyNeedInspirationObjetiveCreation(): void {
		...
		let OBJECTIVE_NAME: string = "Communicate effectively";
  ...
  __page6 = __page6.loginToThinkContent(this.getPlayFourUser().email, this.getPlayOneUser().password);
  ...
  __page7 = __page7.loginToThinkContent(this.getPlayFourUser().email, this.getPlayOneUser().password);
